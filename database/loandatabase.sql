...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2022 at 04:36 PM
...
CREATE TABLE `lon_edit_requests` (
  ...
  `edit_by` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int(11) DEFAULT NULL,
  `seenstatus` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unseen',
  ...
  `loan_owner_id_bk_img` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `granter_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `granter_id_card` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `loan_entry` double(8,2) DEFAULT NULL,
...
CREATE TABLE `notice_tbls` (
  ...
  `notice_pdf` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `notifications` (
  ...
  `n_for` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `n_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `n_type_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `n_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unseen' COMMENT '1=seen,2=unseen',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `recived_loans` (
  ...
  `recived_amount` double(8,2) NOT NULL,
...
INSERT INTO `site_settings` (`id`, `site_logo`, `fb_page_img`, `fb_link`, `insta_link`, `twitter_link`, `linkdin_link`, `mobile_no`, `email`, `office_address`, `map`, `created_at`, `updated_at`) VALUES
(1, 'd-site-logo.jpg', 'd-facebook-page.jpeg', 'https://www.facebook.com/your-username', 'https://www.instagram.com/your-username', 'https://twitter.com/your-username', 'https://bd.linkedin.com/your-username', '+88016*******0', 'helloworld@gmail.com', 'Dhaka, Bangladesh', 'Dhaka, Bangladesh', '2022-11-06 15:24:30', NULL);
...
(1, 'Super Admin', 1, 'superadmin', NULL, 'All', NULL, '2022-11-06 15:24:30', '$2y$10$OeICqq9K02pURE/lgiTQleWMdQcQAOyulVtt1HkC/qQP4CqzZw23e', 'Rw1cCRWJHK', NULL, NULL, NULL),
(2, 'Notic Admin', 4, 'noticadmin', NULL, 'All', NULL, '2022-11-06 15:24:30', '$2y$10$Lfy6Lu4VE76VlFXvproimewbJnrd48R.haSLvv7vGf2GysS9hqkQy', 'PLrMmRxqDS', NULL, NULL, NULL),
(3, 'Manager', 2, 'manager', NULL, 'Dhaka', NULL, '2022-11-06 15:24:30', '$2y$10$xvAWTMiPzg4lT7lHBAUXmONHqk8vVObqgxgTxu2q1Y25mhFTvXRli', 'xEaqvireR7', NULL, NULL, NULL),
(4, 'Loan Officer', 3, 'loanofficer', NULL, 'Dhaka', 3, '2022-11-06 15:24:30', '$2y$10$b8TqSWj/bK6czxAaGeX0MeO49D7uDi6clpYYI.bFLYtGTfwCvt5Vu', 'OhdnhpHeQV', NULL, NULL, NULL);
