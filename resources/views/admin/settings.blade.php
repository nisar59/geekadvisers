    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile" style="border-top: 3px solid #009688;
                ...
                <div class="tile-body">
                    <form class="row" action="{{ url('admin/site-settings') }}" method="post"
                        ...
                        <img src="{{ asset('uploads/logo/') . '/' . $data->panel_logo }}" style=" width: 75px;height: 49px;margin-left: 17px;border: 1px solid;padding: 4px;">
                        <div class="form-group col-md-12">
                            <label class="control-label">Panel Logo</label>
                            <input type="file" name="panel_logo" class="form-control">
                            @error('panel_logo')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
