                        ...
                        <td>
                            ...
                            @elseif($data->status == 3)
                                <button disabled class="btn btn-danger"
                                    href="{{ route('loan.approve', $data->id) }}">Rejected&nbsp;<i
                                        class="fa-solid fa-check"></i></button>
                            @else
                                <a href="{{ route('member.loan.approve', $data->id) }}"
                                    onclick="return confirm('Are you Sure?')"><button class="btn btn-primary"
                                        type="button">Approve Loan</button>
                                    <a href="{{ route('member.loan.rejected', $data->id) }}"
