                ...
                <div class="tile" style="border-top: 4px solid #009688;border-radius: 10px 10px 0px 0px;">
                    ...
                    <div class="tile-body">
                        <form class="row" method="post" enctype="multipart/form-data"
                            action="{{ route('loan.member.update.request', $data->id) }}">
                            @csrf
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label" style="font-weight:bold;">Attach loan customer ID Front photo
                                    :&nbsp;<sup style="color:red">*</sup> </label>
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label" style="font-weight:bold;font-size: 12px;">Attach loan customer
                                    ID Back photo :&nbsp;
                                    <sup style="color:red">*</sup>
                                </label>
                                <input  type="file" value="{{ $data->loan_owner_id_bk_img }}"
                                    class="form-control" name="loan_owner_id_bk_img" onchange="readBackImg(this);">
                            </div>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <textarea class="form-control" name="edit_reason" id="" cols="30" rows="4"></textarea>
